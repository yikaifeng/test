...
function getName() {
	...
	var FNumber = task.field (NUMBER);
	var FMail = task.field (MAIL);
	var FOther = task.field (OTHER);
	
	return pGetIcon(FType) + " " + FNumber + FMail + FOther;
}
